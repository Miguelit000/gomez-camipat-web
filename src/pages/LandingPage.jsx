...
export default function LandingPage() {
  return (
    <div style={{ backgroundColor: '#0f172a', minHeight: '100vh', color: '#f8fafc', fontFamily: 'sans-serif', position: 'relative' }}>
      ...
      <div style={{
        ...
        opacity: 0.08, // Opacidad baja para que sea un reflejo sutil
        zIndex: 0,
        pointerEvents: 'none', // Evita que la imagen interfiera con los clics
        backgroundAttachment: 'fixed' // Hace que el fondo se quede quieto al hacer scroll
      }}></div>

      {/* Todo el contenido va dentro de este div relativo para estar por encima del fondo */}
      <div style={{ position: 'relative', zIndex: 1 }}>
        
        {/* NAVEGACIÓN PÚBLICA */}
        <nav style={{ display: 'flex', justifyContent: 'space-between', padding: '20px 40px', alignItems: 'center', borderBottom: '1px solid rgba(30, 41, 59, 0.5)' }}>
        ...
        <header style={{ textAlign: 'center', padding: '100px 20px', maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.2em', color: '#94a3b8', marginBottom: '40px', lineHeight: '1.6' }}>
            El Trading Journal definitivo con calculadora de riesgo integrada, analítica institucional (SQN, MAE/MFE) y un Centro de Operaciones de Seguridad. Vigila tu rendimiento con una precisión inquebrantable.
          </p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '20px' }}>
            ...
            <a href="#precios" style={{ padding: '15px 30px', backgroundColor: 'rgba(30, 41, 59, 0.7)', color: '#f8fafc', textDecoration: 'none', borderRadius: '8px', fontSize: '1.1em', fontWeight: 'bold', border: '1px solid #334155', backdropFilter: 'blur(4px)' }}>
              Ver Planes
            </a>
          </div>
        </header>
        ...
        <section style={{ padding: '60px 20px' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
            ...
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.7)', padding: '30px', borderRadius: '12px', border: '1px solid rgba(51, 65, 85, 0.5)', backdropFilter: 'blur(8px)' }}>
        ...
        <section id="precios" style={{ padding: '80px 20px', maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', textAlign: 'left' }}>
            ...
            {/* PLAN FREE */}
            <div style={{ backgroundColor: 'rgba(30, 41, 59, 0.7)', padding: '40px', borderRadius: '12px', border: '1px solid rgba(51, 65, 85, 0.5)', backdropFilter: 'blur(8px)' }}>
            ...
            {/* PLAN PRO */}
            <div style={{ backgroundColor: 'rgba(15, 23, 42, 0.9)', padding: '40px', borderRadius: '12px', border: '2px solid #fbbf24', position: 'relative', boxShadow: '0 10px 30px rgba(245, 158, 11, 0.1)', backdropFilter: 'blur(8px)' }}>
        ...
        {/* FOOTER */}
        <footer style={{ textAlign: 'center', padding: '30px', borderTop: '1px solid rgba(30, 41, 59, 0.5)', color: '#64748b', fontSize: '0.9em' }}>
